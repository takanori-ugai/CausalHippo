...
Provide a concise summary (1-2 sentences) that captures the key causal mechanisms:"""
            val overview = llmInterface.generate(overviewPrompt, temperature = 1.0, maxTokens = 150)
        ...
        builder
            ...
            .append(
                "\n\nFinal answer requirements:\n" +
                    ...
                    "- Prefer a single entity/date/number/phrase copied from context.\n" +
                    "- No explanation, no full sentence, no labels, no alternatives.\n" +
                    "- If multiple forms exist, choose the minimal canonical form.\n\n" +
                    "Final answer:",
            )
        return builder.toString()
    }
