...
fun main(args: Array<String>) {
    val defaults =
        OpenAlexFullTextToMusiqueCliArgs(
            inputPath = "data/openalex_eval_dataset.jsonl",
            outputPath = "data/openalex_eval_dataset_fulltext_musique.jsonl",
        )
    val resolved = parseOpenAlexFullTextToMusiqueCliArgs(args, defaults)
    OpenAlexFullTextToMusiqueConverter().convert(
        inputPath = resolved.inputPath,
        outputPath = resolved.outputPath,
    )
}

private data class OpenAlexFullTextToMusiqueCliArgs(
    val inputPath: String,
    val outputPath: String,
)

private fun parseOpenAlexFullTextToMusiqueCliArgs(
    args: Array<String>,
    defaults: OpenAlexFullTextToMusiqueCliArgs,
): OpenAlexFullTextToMusiqueCliArgs {
    ...
    return OpenAlexFullTextToMusiqueCliArgs(
