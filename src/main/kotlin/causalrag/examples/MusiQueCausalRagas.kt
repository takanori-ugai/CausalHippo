...
object MusiQueCausalRagas {
    ...
    fun main(args: Array<String>) {
        ...
        val resultsDir = Path.of("eval_results").resolve("musique_causal_ragas_$timestamp")
    ...
    private fun resolveInputPath(args: Array<String>): Path {
        ...
        if (args[0] == "--input") {
            ...
            if (value.isNullOrBlank()) {
                System.err.println("Usage: MusiQueCausalRagas [--input <path>] or MusiQueCausalRagas [<path>]")
                kotlin.system.exitProcess(1)
            }
    ...
    private fun writeTempConfig(
        ...
        val tempDir = Files.createTempDirectory("causalrag-musique-ragas")
        tempDir.toFile().deleteOnExit()
        val configPath = tempDir.resolve("musique-causal-ragas-config.json")
