...
fun main(args: Array<String>) {
    val defaults =
        OpenAlexIntroToMusiqueCliArgs(
            inputPath = "data/openalex_eval_dataset.jsonl",
            outputPath = "data/openalex_eval_dataset_intro_musique.jsonl",
        )
    val resolved = parseOpenAlexIntroToMusiqueCliArgs(args, defaults)
    OpenAlexIntroductionToMusiqueConverter().convert(
        inputPath = resolved.inputPath,
        outputPath = resolved.outputPath,
    )
}

private data class OpenAlexIntroToMusiqueCliArgs(
    val inputPath: String,
    val outputPath: String,
)

private fun parseOpenAlexIntroToMusiqueCliArgs(
    args: Array<String>,
    defaults: OpenAlexIntroToMusiqueCliArgs,
): OpenAlexIntroToMusiqueCliArgs {
    ...
    return OpenAlexIntroToMusiqueCliArgs(
